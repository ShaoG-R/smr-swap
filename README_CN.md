...
|------|----------|---------|---------|------|
| 单线程读取 | 5.47 ns | 8.98 ns | **快 39%** | 纯读取性能 |
| 单线程写入 | 148.51 ns | 129.37 ns | 慢 15% | Epoch 管理开销 |
| 多线程读取 (2) | 6.90 ns | 9.02 ns | **快 23%** | 无竞争 |
| 多线程读取 (4) | 9.13 ns | 9.26 ns | **快 1%** | 一致的扩展性 |
| 多线程读取 (8) | 14.36 ns | 9.67 ns | 慢 48% | Epoch 协调成本 |
| 混合读写 (2 读) | 151.23 ns | 456.36 ns | **快 67%** | 1 写 + 2 读 |
| 混合读写 (4 读) | 152.27 ns | 452.69 ns | **快 66%** | 1 写 + 4 读 |
| 混合读写 (8 读) | 156.02 ns | 493.48 ns | **快 68%** | 1 写 + 8 读 |
| 批量读取 (10x) | 9.89 ns | 10.14 ns | **快 2%** | 单个 Pin 多次读取 |
| 持有守卫的读取 | 140.31 ns | 481.23 ns | **快 71%** | 读取者持有守卫期间写入 |
